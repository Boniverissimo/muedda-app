...
$backup = Join-Path $project "backup_muedda_design_v10_$stamp"
$log = Join-Path $project "muedda_analyze_v10.txt"
$installLog = Join-Path $project "muedda_install_v10.txt"
...
try {
  Write-Host "Aplicando o Design de Conclusão V10..." -ForegroundColor Cyan
  ...
  Write-Host ""
  Write-Host "Design V10 aplicado." -ForegroundColor Green
