...
class Account extends DataClass implements Insertable<Account> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, name, initialBalanceCents, isActive, createdAt);
  @override
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final LedgerEntriesDao ledgerEntriesDao = LedgerEntriesDao(
    this as AppDatabase,
  );
...
final class $$AccountsTableReferences
  ...
  _creditCardsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.creditCards,
    aliasName: 'accounts__id__credit_cards__account_id',
  );
  ...
  _sourceAccountEntriesTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.ledgerEntries,
    aliasName: 'accounts__id__ledger_entries__account_id',
  );

  $$LedgerEntriesTableProcessedTableManager get sourceAccountEntries {
    ...
    final cache = $_typedResult.readTableOrNull(
      _sourceAccountEntriesTable($_db),
    );
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
  ...
  static MultiTypedResultKey<$LedgerEntriesTable, List<LedgerEntry>>
  _destinationAccountEntriesTable(_$AppDatabase db) =>
      MultiTypedResultKey.fromTable(
        db.ledgerEntries,
        aliasName: 'accounts__id__ledger_entries__destination_account_id',
      );

  $$LedgerEntriesTableProcessedTableManager get destinationAccountEntries {
    ...
    final cache = $_typedResult.readTableOrNull(
      _destinationAccountEntriesTable($_db),
    );
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
...
class $$AccountsTableFilterComposer
  ...
  Expression<bool> sourceAccountEntries(
  ...
  Expression<bool> destinationAccountEntries(
    Expression<bool> Function($$LedgerEntriesTableFilterComposer f) f,
  ) {
    final $$LedgerEntriesTableFilterComposer composer = $composerBuilder(
      composer: this,
...
class $$AccountsTableAnnotationComposer
  ...
  Expression<T> sourceAccountEntries<T extends Object>(
  ...
  Expression<T> destinationAccountEntries<T extends Object>(
    Expression<T> Function($$LedgerEntriesTableAnnotationComposer a) f,
  ) {
    final $$LedgerEntriesTableAnnotationComposer composer = $composerBuilder(
      composer: this,
    ...
    extends
        RootTableManager<
          ...
          PrefetchHooks Function({
            ...
            bool sourceAccountEntries,
            bool destinationAccountEntries,
        ...
        TableManagerState(
          ...
          prefetchHooksCallback:
              ({
                ...
                sourceAccountEntries = false,
                destinationAccountEntries = false,
                ...
                return PrefetchHooks(
                  ...
                  explicitlyWatchedTables: [
                    ...
                    if (sourceAccountEntries) db.ledgerEntries,
                    if (destinationAccountEntries) db.ledgerEntries,
                    ...
                    return [
                      ...
                      if (destinationAccountEntries)
                        ...
                        >(
                          currentTable: table,
                          referencedTable: $$AccountsTableReferences
                              ._destinationAccountEntriesTable(db),
                          managerFromTypedResult: (p0) =>
                              $$AccountsTableReferences(
                                db,
                                table,
                                p0,
                              ).destinationAccountEntries,
                          referencedItemsForCurrentItem:
                              (item, referencedItems) => referencedItems.where(
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback:
              ({ledgerEntriesRefs = false, recurringTransactionsRefs = false}) {
                return PrefetchHooks(
                  db: db,
                  explicitlyWatchedTables: [
...
final class $$CreditCardsTableReferences
  ...
  static $AccountsTable _accountIdTable(_$AppDatabase db) =>
      db.accounts.createAlias('credit_cards__account_id__accounts__id');
  ...
  _ledgerEntriesRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.ledgerEntries,
    aliasName: 'credit_cards__id__ledger_entries__credit_card_id',
  );
...
final class $$LedgerEntriesTableReferences
  ...
  static $CreditCardsTable _creditCardIdTable(_$AppDatabase db) => db
      .creditCards
      .createAlias('ledger_entries__credit_card_id__credit_cards__id');
